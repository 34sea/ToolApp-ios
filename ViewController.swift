...
class ViewController: UIViewController {
   ...
   // let dbHelperAdmin = DatabaseAdmin()
    ...
    func nomesPrint(){
        let nomes = "martinho#domingos#macovere#joana#francisca"
        
        let imprimirTodos = nomes.split(separator: "#")
        ...
        let nomesAtualizados = nomesPrintUpdate(nomes, posicao: 1)
        print(nomesAtualizados)
    }
